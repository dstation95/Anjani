      ...
      <Row>
        <Col xs='12' md='8'>
          ...
          <Row>
            ...
            <Col xs='8'>
              <span className='order-label one-line-ellipsis'>{` ${order.address.line1}, ${order.address.city}, ${order.address.state}, ${order.address.postal_code}, (AddressLine2 :${order.address.line2})`}</span>
            </Col>
          </Row>
        </Col>
