  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h3 className='text-uppercase'>Become A Anjani Seller!</h3>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  {/* <h3>Would you like to sell your products on Anjani Store?</h3> */}
                  <h3>Currently Not Supporting External Sellers</h3>
                  <h5>Stay informed for future updates</h5>
                  <b>Apply for Future Oppurntunites to become a seller!</b>
                </div>
              </Col>
