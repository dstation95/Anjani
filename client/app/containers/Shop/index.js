...
class Shop extends React.PureComponent {
  ...
  render() {
    const { products, advancedFilters, filterProducts, fetchBrandProducts  } = this.props;
      ...
      <div className='shop'>
        <Row xs='12'>
          <Col
            ...
            lg={{ size: 3, order: 1 }}
          >
            <ProductFilter filterProducts={filterProducts} fetchBrandProducts ={fetchBrandProducts}  />
          </Col>
          <Col
            xs={{ size: 12, order: 2 }}
            sm={{ size: 12, order: 2 }}
